...
import (
	...
	"github.com/nineinfra/seatunnel-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(seatunnelv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f351afc1.nineinfra.tech",
	...
	if err = (&controller.SeatunnelJobReconciler{
