...
const (
	NINEINFRA_ENV_SEATUNNEL_DEBUG_MODE string = "NINEINFRA_ENV_SEATUNNEL_DEBUG_MODE"
	NINEINFRA_ENV_SEATUNNEL_DEBUG_TIME string = "NINEINFRA_ENV_SEATUNNEL_DEBUG_TIME"
	NINEINFRA_ENV_SEATUNNEL_ENGINE     string = "NINEINFRA_ENV_SEATUNNEL_ENGINE"
)
const (
	NINEINFRA_ENV_SEATUNNEL_DEBUG_MODE_DEFAULT string = "off"
	NINEINFRA_ENV_SEATUNNEL_DEBUG_MODE_ON      string = "on"
	NINEINFRA_ENV_SEATUNNEL_DEBUG_MODE_OFF     string = "off"
	NINEINFRA_ENV_SEATUNNEL_DEBUG_TIME_DEFAULT int    = 3600
	NINEINFRA_ENV_SEATUNNEL_ENGINE_DEFAULT     string = "spark"
	NINEINFRA_ENV_SEATUNNEL_ENGINE_SPARK       string = "spark"
	NINEINFRA_ENV_SEATUNNEL_ENGINE_FLINK       string = "flink"
)

var (
	NINEINFRA_NAMED_ENV_LIST = []string{
		NINEINFRA_ENV_SEATUNNEL_DEBUG_MODE,
		NINEINFRA_ENV_SEATUNNEL_ENGINE,
		NINEINFRA_ENV_SEATUNNEL_DEBUG_TIME,
	}
)
